    ...
    return (
      <AutoForm placeholder={true} ref={ref => { fRef = ref; }} schema={bridge} onSubmit={data => this.submit(data, fRef)} >
        <Segment>
          ...
          <NumField id='addreview-rating' decimal={false} max={5} min={1} placeholder="Rating from 1 to 5" label="Star Rating" name='rating'/>
          <TextField id='addreview-review' placeholder="Review for this professor" label="Write Your Review" name='review'/>
          <SubmitField id='addreview-submit' value='Submit'/>
          <ErrorsField/>
